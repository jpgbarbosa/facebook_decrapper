...
hash["politica"]["objects"]["party"]["objects"]["PSD"]["objects"]["people"]["objects"]["passos"] = Hash.new
hash["politica"]["objects"]["party"]["objects"]["PSD"]["objects"]["people"]["objects"]["passos"]["semantics"] = ["passos coelho","primeiro-ministro","primeiro ministro"]
...
hash["politica"]["objects"]["party"]["objects"]["PC"]["semantics"] = ["pcp","partido comunista","comunista", "comuna"]
...
hash["politica"]["objects"]["party"]["objects"]["PC"]["objects"]["people"]["objects"]["jeronimo"]["semantics"] = ["jerónimo de sousa"]
...
hash["politica"]["objects"]["party"]["objects"]["BE"]["objects"]["people"]["objects"]["louca"]["semantics"] = ["francisco louçã"]
